...
To address this issue, these four groups have worked to establish the Campus Sustainability Data Collector (CSDC). The CSDC is based on the STARS Reporting Tool and is available for all schools (free of charge) that would like to submit data to these groups in one single survey.Please find more information here: https://www.princetonreview.com/green-data-partnership.
...
Questions it covers include:<br>

What is the percentage of food expenditures that goes toward local, organic or otherwise environmentally preferable food?
<br>
Does the school offer programs including mass transit programs, bike sharing, facilities for bicyclists, bicycle and pedestrian plans, car sharing, a carpool discount, carpool/vanpool matching, cash-out of parking, prohibiting idling, local housing, telecommuting, and a condensed workweek?<br>
Does the school have a formal committee with participation from students that is devoted to advancing sustainability on campus?<br>
Are school buildings that were constructed or underwent major renovations in the past three years LEED certified?<br>
What is a school's overall waste-diversion rate?<br>
Does the school have an environmental studies major, minor or concentration?<br>
Do the school's students graduate from programs that include sustainability as a required learning outcome or include multiple sustainability learning outcomes?<br>
Does the school have a formal plan to mitigate its greenhouse gas emissions?<br>
What percentage of the school's energy consumption is derived from renewable resources?<br>
Does the school employ a dedicated full-time (or full-time equivalent) sustainability officer?	<br>
